      ...
      <three.group rotation-x={hinge} position={[0, -0.04, 0.41]}>
        <group position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh geometry={nodes['Cube008_2'].geometry}>
            <meshBasicMaterial color="black" /> {/* Optional: make screen black behind iframe */}
          </mesh>
          ...
          <Html
            ...
            position={[0, 0.07, -0.09]} // Slightly higher
            scale={0.35} // Slightly smaller
          >
            <div style={{ width: '800px', height: '450px', borderRadius: '10px', overflow: 'hidden' }}>
              <iframe src="https://ira-qa.globtech.in/" width="100%" height="100%" style={{ border: 'none' }} />
            </div>
          </Html>
        </group>
      </three.group>
  ...
  return (
    <web.main style={{ background: props.open.to([0, 1], ['#f0f0f0', '#d25578']) }}>
      ...
      <Canvas dpr={[1, 2]} camera={{ position: [0, 0, -30], fov: 35 }}>
        <three.pointLight position={[10, 10, 10]} intensity={1.5} color={props.open.to([0, 1], ['#f0f0f0', '#00000'])} />
